...
class DataBaseHelper {
    /* Brings all the data from FileSearchApplication */
   protected DataBaseHelper(String word, String filepath, int totalNoOfWords, String errorMessage)  {
        storingDataToDataBase(word, filepath, totalNoOfWords, errorMessage);
    }

    private static void storingDataToDataBase(String word, String filepath, int totalNoOfWords, String errorMessage) {
        ...
        try {
           ...
           Connection connectionToDataBase = DriverManager.getConnection("jdbc:mysql://localhost:3306/elixr1", "root", "Ashu@2406");
